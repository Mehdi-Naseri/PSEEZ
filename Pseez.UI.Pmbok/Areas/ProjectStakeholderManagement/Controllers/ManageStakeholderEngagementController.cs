...
namespace Pseez.UI.Pmbok.Areas.ProjectStakeholderManagement.Controllers
{
    public class ManageStakeholderEngagementController : ProjectProcessesBaseController
    {
        public ManageStakeholderEngagementController(IUnitOfWorkPseezEnt uow,
