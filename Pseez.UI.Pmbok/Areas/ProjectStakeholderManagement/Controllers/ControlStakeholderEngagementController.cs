...
{
    public class ControlStakeholderEngagementController : ProjectProcessesBaseController
    {
        public ControlStakeholderEngagementController(IUnitOfWorkPseezEnt uow,
