...
namespace Pseez.UI.Pmbok.Areas.ProjectScopeManagement.Controllers
{
    public class CollectRequirementsController : ProjectProcessesBaseController
    {
        public CollectRequirementsController(IUnitOfWorkPseezEnt uow,
