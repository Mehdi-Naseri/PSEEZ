...
using Identity.ViewModels.ViewModelsEn;
using Identity.Models.Models;
using System.Threading.Tasks;
using Microsoft.AspNet.Identity.EntityFramework;
using Pseez.Extentions.MapperConfigure.Extention.Identity;

namespace Pseez.UI.Pmbok.Areas.Admin.Controllers
{
    [Authorize(Roles = "AdminEnt,AdminPmbok")]
    public class IdentityController : Controller
    {
        ...
        {
            IEnumerable<UserRoleViewModel> userRoles = _identityUserRoleService.GetAllUsersRoles().OrderBy(r => r.UserName).MapFaToEn();
            return View(userRoles);
        }

        public ActionResult AllUsersRolesRead()
        {
            IEnumerable<UserRoleViewModel> userRoleViewModel = _identityUserRoleService.GetAllUsersRoles().OrderBy(r => r.UserName).ToList().MapFaToEn();
