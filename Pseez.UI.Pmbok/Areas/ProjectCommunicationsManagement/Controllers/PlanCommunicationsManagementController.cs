...
{
    public class PlanCommunicationsManagementController : ProjectProcessesBaseController
    {
        public PlanCommunicationsManagementController(IUnitOfWorkPseezEnt uow,
