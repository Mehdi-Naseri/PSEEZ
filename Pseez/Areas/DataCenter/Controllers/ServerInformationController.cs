...
namespace Pseez.Areas.DataCenter.Controllers
{
    public class ServerInformationController : Controller
    {
        ...
        {
            //PseezEntContext PseezEntdb = new PseezEntContext();
            //return View(PseezEntdb.Servers);
        ...
        {
            string stringWin32class = "Win32_OperatingSystem" ;
            List<string[]> ServerInfo = ServerInfoWin32class(ServerIP, Username, Password, stringWin32class);
            ViewBag.IP = ServerIP;
            return PartialView("_ServerInformation", ServerInfo);
        }

        private List<string[]> ServerInfoWin32class(string strIP,string strUsername, string strPassword, string stringWin32class)
        {
            List<string[]>  ServerInfoResult = new List<string[]>();
                ...
                foreach (ManagementObject ManagementObject1 in ManagementClass1.GetInstances())
                {
                    foreach (PropertyData property in PropertyDataCollection1)
                    {
                        ...
                        try
                        {
                            ...
                            string[] stringWin32classPropertyValue = new string[] { stringWin32class, property.Name, ManagementObject1.Properties[property.Name].Value.ToString() };
            ...
            {
                ServerInfoResult.Add(new string[]{"اتصال به سرور امکان پذیر نشد",strIP,ex.Message});
            }
